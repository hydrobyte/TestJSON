...
type
  ...
  public
    ...
    //   getters
    function getInt(aDfl: integer = 0): integer;
    function getNum(aDfl: double = 0): double;
    function getStr(aDfl: string = ''): string;
    function getBool(aDfl: boolean = false): boolean;
    function getType(aDfl: myJDType = dtUnset): myJDType;
...
function myJSONItem.getBool(aDfl: boolean): boolean;
var
  f: double;
begin
  // defaulting
...
function myJSONItem.getInt(aDfl: integer): integer;
var
  f: double;
begin
...
function myJSONItem.getNum(aDfl: double): double;
begin
  ...
  result := StrToFloatDef(fValue, aDfl);
end;

function myJSONItem.getStr(aDfl: string): string;
begin
...
function myJSONItem.getType(aDfl: myJDType): myJDType;
begin
  result := aDfl;
